...
public class Camera2VideoFragment extends Fragment
    ...
    StandardProgressDialog mmDialog;
    /**
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        if(getArguments()!= null){
            ...
            bitmap1 = arguments.getString("bitmap1");
            idNo = arguments.getString("idNo");

            Log.d("idNO",idNo);
        }

        file = new File(Environment.getExternalStoragePublicDirectory(DIRECTORY_DCIM)+"/"+idNo+".mp4");
        mmDialog = new StandardProgressDialog(getActivity().getWindow().getContext());
        mTextureView = view.findViewById(R.id.texture);
        mButtonVideo = view.findViewById(R.id.btnRecord);
        mButtonVideo.setOnClickListener(this);

        contextaaa = getActivity().getApplicationContext();
        Log.d("idNO",String.valueOf(contextaaa));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnRecord: {
                ...
                Bitmap bitmap_textureview= ScreenShott.getInstance().takeScreenShotOfTextureView(mTextureView);
    ...
    private String getVideoFilePath(Context context) {
        ...
        final File dir = context.getExternalFilesDir(DIRECTORY_DCIM);
    ...
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    private void stopRecordingVideo(View v) {
        // UI
        ...
        Log.d("selectedPath",file.toString());
        String selectedPath = FilePath.getPath(getActivity(),Uri.fromFile(file));
